...
Route::apiResource('notebooks/{notebook}/products-offered', \App\Http\Controllers\ProductOfferedController::class)
    ->parameters(['products-offered' => 'product'])
    ->names('notebook.productOffered');